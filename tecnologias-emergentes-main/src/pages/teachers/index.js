...
import StudentActions from './components/teachersActions';
...
const rows = [
  createData(1234567890, 'Juliana', 'Perez Solis', 'Calle 10 # 25-10, Barrio San Jose, Bogota', 32),
  createData(2345678901, 'Luisa Fernandez', 'Ortiz Cruz', 'Avenida 5 # 14-78, Cojunto residencial La Acacias, Medellin', 27),
  ...
  createData(6789012345, 'Pablo', 'Catro Ramirez', 'Carrera 25 # 30-10, Barrio El Prado, Cartagena', 28)
];
